...
## 2026-08-20 - Exhausted Form Interaction Dead-ends
**Learning:** Leaving a finite-option form visible when all its options are exhausted (e.g., all available items have been assigned) creates a dead-end interaction. Users might try to interact with disabled elements or be confused about the next step.
