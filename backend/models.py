...
class GeneralConfig(BaseModel):
    ...
    time_step_size: float = Field(0.001, gt=0, le=10000, description="Time step size")
    save_results_frequency: int = Field(10, ge=1, le=1000000, description="Frequency to save results")
