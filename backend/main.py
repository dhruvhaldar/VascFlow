...
async def limit_request_size(request: Request, call_next):
    ...
    if transfer_encoding and b"chunked" in transfer_encoding.lower():
        ...
        # 🛡️ Sentinel: Reject ALL chunked requests because FastAPI eagerly spools
        # UploadFile payloads to disk before route handlers execute. Allowing chunked
        # requests on any endpoint enables Disk Exhaustion DoS attacks.
