...
def process_mesh(file: UploadFile, background_tasks: BackgroundTasks):
    ...
    asyncio event loop.
    """
    # ⚡ Bolt: Offload file system cleanup to a background task
    # This prevents directory traversal (os.scandir) and sequential file deletions
    # from blocking the critical request-response path, improving TTFB.
