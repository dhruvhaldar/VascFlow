<script>
    ...
    async function handleFileSelect() {
        ...
        try {
            ...
            // If the user uploads a surface mesh (.vtp) and it didn't need decimation,
            // the backend returns it as-is (viz_file == filename).
            ...
            if (file.name.toLowerCase().endsWith('.vtp') && data.viz_file === file.name) {
